...
echo make buildAllDebug       - Builds and configures TXM with javadoc and docbook documentation. 
...
echo make buildNoDocDebug     - Builds and configures TXM without javadoc and docbook documentation.
                                The compiled classes have debug information.
...
echo make distributions       - Builds and configures TXM with all documentations and creates distribution package
goto end
