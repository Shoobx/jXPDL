...
Var TOG_JavaFullVersionSupport  ; minimum version of java that our program support
Var TOG_UserJavaHomeVersion     ; user set their java_home to which version
Var TOG_UserHasRightJavaVersion ; user set their java path to which version
...
Function create_page_setjava
    ...
    # Define minimum version of java that our application support
...
Function GetJavaInfo
    ;(0) check if user has lover version of java than the minimum requirement; quit the installation
...
Function Check_JavaVersionNumber
    ;check if user has lover version of java than the minimum requirement; quit the installation
    Push $0 
    ${if} ${RunningX64}
        SetRegView 64
    ${Else}
    ...
    ; # do not update the Java version (for checking only)
    ...
    ${If} $0 S< $TOG_JavaFullVersionSupport
        ...
        StrCpy $1 $TOG_JavaFullVersionSupport "" 2	
       	MessageBox MB_OK "${APP_NAME} needs Java, please install Java $1 64 Bit or a higher version before installing ${APP_NAME}." IDOK quit_instaillation
    ${EndIf}
...
Function Check_JavaHome
    ...
    ;MessageBox MB_OK "user set JAVA_HOME to $TOG_JavaHome $\nUser used java version: $TOG_UserJavaHomeVersion"
...
Function GetUserJavaVersionByJavaHome
    ...
    Push $R6
     ...
     StrCpy $TOG_UserJavaHomeVersion $R3 3 $R0  ;get java major and minor version(x.y) from user java_home
     ...
     ${If} $R4 > 2
        ...
        ${EndIf}
     ${ElseIf} $R4 = 2
        StrCpy $R5 $TOG_UserJavaHomeVersion 1 1             ; minor version fron java_home
        StrCpy $R6 $TOG_JavaFullVersionSupport 1 2          ; minor version fron minimum support
        ${If} $R5 S< $R6
            StrCpy $TOG_UserHasRightJavaVersion "No"
        ${Else}
            StrCpy $TOG_UserHasRightJavaVersion "Yes"
...
Function Check_${Version}
    ...
    Push $2
	Push $3
    Push $4     ; java major version
    Push $5     ; java minor version
    Push $R1
    Push $R2
    Push $R9
    ${if} ${RunningX64}
...
start_check_${Version}:
    ...
    StrCmp $R2 "" end_check_${Version} +1 ;Check whether 32-bit JDK exists
        ...
        StrCpy $4 $TOG_JavaFullVersionSupport 1     ;get major version of java
        StrCpy $5 $TOG_JavaFullVersionSupport 1 2   ;get minor version of java
		
        ;skip if minor version of java lower than minimum requirement
