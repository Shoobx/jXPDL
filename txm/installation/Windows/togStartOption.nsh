...
!define TOG_CUSTOMPAGE_STARTOPTION_SUBTITLE "Choose which Start options of ${APP_FULL_NAME} ${VERSION}-${RELEASE} you want to install."
...
Function create_page_startoption
    ...
    ;(0) Create header title & header subtitle and Set name of Start menu as ${APP_FULL_NAME} and Set every CheckBox state as ${BST_CHECKED}, except QUICKLAUNCH
