...
!define TOG_CUSTOMPAGE_DIRECTORY_TEXT "Setup will install ${APP_FULL_NAME} ${VERSION}-${RELEASE} in the following folder. To install in a different folder, click Browse and select another folder. "
...
Function OnClick_BrowseButton_Directory
    ...
    nsDialogs::SelectFolderDialog /NOUNLOAD "Select the folder to install ${APP_FULL_NAME}." $R0
    Pop $0
