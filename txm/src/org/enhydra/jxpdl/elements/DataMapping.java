...
public class DataMapping extends XMLComplexElement {
   ...
   protected void fillStructure() {
      XMLAttribute attrFormal = new XMLAttribute(this, "Formal", true);
      XMLAttribute attrDirection = new XMLAttribute(this,
                                                    "Direction",
                                                    false,
                                                    new String[] {
      ...
      Actual refActual = new Actual(this);
      TestValue refTestValue = new TestValue(this);
